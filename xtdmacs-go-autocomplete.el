...
(defun ac-go-invoke-autocomplete (arg)
...
(defun ac-go-candidates ()
  (let ((candidates (ac-go-get-candidates
                     (ac-go-format-autocomplete (ac-go-invoke-autocomplete "-fallback-to-source")))))
    (if (not candidates)
        (let ((candidates (ac-go-get-candidates
                           (ac-go-format-autocomplete (ac-go-invoke-autocomplete "-source")))))
...
(provide 'xtdmacs-go-autocomplete)
