(defface code-face-status-ok
  '((t (:foreground "#005f00")))
  "status codes KEERROR."
  :group 'code
  )

(defface code-face-status-error
  '((t (:foreground "#870000")))
  "status codes KEERROR."
  :group 'code
  )
...
(defface code-face-status-other
  '((t (:foreground "#af5fd7"))) "other status code (KETIMEOUT... etc)."
  :group 'code
  )

(defface code-face-log
  '((t (:foreground "#5f5f00")))
  "logging."
  :group 'code
  )

(defface code-face-global-variable
  '((t (:foreground "#ff00ff")))
  "global variable."
  :group 'code
  )

(defface code-face-global-variable-const
  '((t (:foreground "#ff00ff" :weight bold)))
  "const global variable."
  :group 'code
  )

(defface code-face-global-variable-const-static
  '((t (:foreground "#ff00ff" :underline t :weight bold)))
  "const static global variable."
  :group 'code
  )

(defface code-face-global-variable-static
  '((t (:foreground "#ff00ff" :underline t)))
  "static global variable."
  :group 'code
  )

(defface code-face-local-variable
  '((t (:foreground "#7f7f7f")))
  "local variable."
  :group 'code
  )

(defface code-face-local-variable-const
  '((t (:foreground "#4e4e4e" :weight bold)))
  "const local variable."
  :group 'code
  )

(defface code-face-local-variable-const-static
  '((t (:foreground "#7f7f7f" :underline t :weight bold)))
  "const static local variable."
  :group 'code
  )

(defface code-face-local-variable-static
  '((t (:foreground "#7f7f7f" :underline t)))
  "static local variable."
  :group 'code
  )

(defface code-face-param
  '((t (:foreground "#008787")))
  "parameter."
  :group 'code
  )

(defface code-face-param-const
  '((t (:foreground "#008787" :weight bold)))
  "const parameter."
  :group 'code
  )

(defface code-face-macro
  '((t (:foreground "#008787" :underline t)))
  "macro"
  :group 'code
  )

(defface code-face-class-member
  '((t (:foreground "#87afff")))
  "member variable"
  :group 'code
  )

(defface code-face-class-member-const
  '((t (:foreground "#87afff" :weight bold)))
  "const member variable"
  :group 'code
  )

(defface code-face-class-member-const-static
  '((t (:foreground "#87afff" :underline t :weight bold)))
  "static const member variable"
  :group 'code
  )

(defface code-face-class-member-static
  '((t (:foreground "#87afff" :underline t)))
  "static member variable"
  :group 'code
  )

(defface code-face-counter
  '((t (:foreground "#875f00")))
  "iterator/counter"
  :group 'code
  )

(defface code-face-counter-const
